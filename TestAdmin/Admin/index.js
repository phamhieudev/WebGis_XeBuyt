...
//tram là sinh viên
app.get("/vung/list", function(req, res){
  pool.connect((err, client, release) => {
      if (err) {
        return console.error('Error acquiring client', err.stack)
      }
      client.query('SELECT * FROM vung ORDER BY id ASC', (err, result) => {
        release()
        if (err) {
            res.end();
        ...
        res.render("vung_list.ejs",{danhsachvung:result});        
      });
    });
...
app.get("/duong/list", function(req, res){
  pool.connect((err, client, release) => {
      if (err) {
        return console.error('Error acquiring client', err.stack)
      }
      client.query('SELECT * FROM duong ORDER BY id ASC', (err, result) => {
        release()
        if (err) {
            res.end();
          return console.error('Error executing query', err.stack)
        ...
        // console.log(result.rows);
        res.render("duong_list.ejs",{danhsachduong:result});        
      });
    });
    // res.render("tram_list.ejs");
